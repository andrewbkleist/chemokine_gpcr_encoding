...
# Below is attempt to color by residue type; works but needs to be expanded to make rule that aopplies to full table instead of individual column callouts
# reactable(data, filterable = TRUE, defaultPageSize = 46,
#           columns = list(
#             protein = colDef(style = list(position = "sticky",left = 0,
#                                           background ="#fff", zIndex = 1)),
