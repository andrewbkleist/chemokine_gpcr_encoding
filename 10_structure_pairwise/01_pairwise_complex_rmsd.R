# Description:
# Calculates pairwise RMSD of all complexes. Does so first by aligning GPCRs,
# then takes pariwise RMSD for all structurally equivalent CA in chemokine
# pairs. 
...
# write csv
write_csv(data, "10_structure_pairwise/output/pairwise_complex_rmsd.csv")
