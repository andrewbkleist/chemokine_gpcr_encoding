...
##### 1: CALCULATE INTERMOLECULAR CONTACTS FROM CK-CKR COMPLEXES ###############
  ...
  lookup.bwccn <- read.csv("01_structure_contacts/data/processed/lookup_pdb_to_gnccn_20211012.csv")
  ...
  # (14) CCL3:CCR5
  cna.7f1t <- LoadAtlas("01_structure_contacts/data/raw/7F1TPREP1634064562.txt",
                         "clean_7f1t_ck", "ccn_7f1t_ck",     # object resno, ccn
                         "clean_7f1t_ckr", "bw_7f1t_ckr",    # ligand resno, bw
                         "7f1t",                              # PDB ID
                         "full")                              # PDB "class"
  
  # (15) CCL5:CCR5 (Gi-bound)
  cna.7f1r <- LoadAtlas("01_structure_contacts/data/raw/7F1RPREP1634058000.txt",
                       "clean_7f1r_ck", "ccn_7f1r_ck",     # object resno, ccn
                       "clean_7f1r_ckr", "bw_7f1r_ckr",    # ligand resno, bw
                       "7f1r",                              # PDB ID
                       "full")                              # PDB "class"
  
  # (16) CCL3:CCR5 (Gi-bound)
  cna.7f1q <- LoadAtlas("01_structure_contacts/data/raw/7F1QPREP1634057856.txt",
                       "clean_7f1q_ck", "ccn_7f1q_ck",     # object resno, ccn
                       "clean_7f1q_ckr", "bw_7f1q_ckr",    # ligand resno, bw
                       "7f1q",                              # PDB ID
                       "full")                              # PDB "class"
  
  # (17) Met-CCL5:CCR5 (Gi bound)
  cna.7o7f <- LoadAtlas("01_structure_contacts/data/raw/7O7FPREP1634058651.txt",
  ...
  cna.master <- rbind(cna.1ilp, cna.6fgp, cna.2mpm, cna.2n55, cna.2k05, 
                      ...
                      cna.7f1t, cna.7f1r, cna.7f1q, cna.7o7f)
  ...
  # write df
  write_csv(cna.master, "01_structure_contacts/output/RIN_atom_20211012.csv")
  ...
  # write df
  write_csv(cna.master, "01_structure_contacts/output/RIN_residue_20211012.csv")
