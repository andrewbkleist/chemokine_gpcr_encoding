...
##### 1: CALCULATE INTERMOLECULAR CONTACTS FROM CK-CKR COMPLEXES ###############
  ...
  # (13) CCL5:CCR5 **MODEL**
  cna.zheng <- LoadAtlas("01_structure_contacts/data/raw/ZHENGMODELCLEAN1603803275 copy.txt",
  ...
  cna.master <- rbind(cna.1ilp, cna.6fgp, cna.2mpm, cna.2n55, cna.2k05, 
                      cna.5uiw, cna.4rws, cna.4xt1, cna.5wb2, cna.6lfo, cna.6wwz, cna.ngo, cna.zheng)
...
##### 2: CALCULATE INTERMOLECULAR CONTACTS - 1 ANGSTROM CUTOFF #################
  
  # load CCN and BW conversion file
  lookup.bwccn <- read.csv("01_structure_contacts/data/processed/lookup_pdb_to_gnccn_20200918.csv")
  
  # (1) CXCL8:CXCR1
  cna.1ilp <- LoadAtlas("01_structure_contacts/data/raw/1ILPCKCLEAN1614892823_1A.txt",
                        "clean_1ilp_ck", "ccn_1ilp_ck",     # object resno, ccn
                        "clean_1ilp_ckr", "bw_1ilp_ckr",    # ligand resno, bw
                        "1ilp",                             # PDB ID
                        "soluble")                          # PDB "class"
  ...
  # (2) CCL11:CCR3
  cna.2mpm <- LoadAtlas("01_structure_contacts/data/raw/2MPMCKCLEAN1614892967_1A.txt",
                        "clean_2mpm_ck", "ccn_2mpm_ck",   # object resno, ccn
                        "clean_2mpm_ckr", "bw_2mpm_ckr",  # ligand resno, bw
                        "2mpm",                           # PDB ID
                        "nmr")                            # PDB "class"
  ...
  # (3) CXCL12:CXCR4
  cna.2n55 <- LoadAtlas("01_structure_contacts/data/raw/2N55CKCLEAN1614893009_1A.txt",
                        "clean_2n55_ck", "ccn_2n55_ck",     # object resno, ccn
                        "clean_2n55_ckr", "bw_2n55_ckr",  # ligand resno, bw
                        "2n55",                           # PDB ID
                        "soluble")                        # PDB "class"
  ...
  # (4) vMIPII:CXCR4
  cna.4rws <- LoadAtlas("01_structure_contacts/data/raw/4RWSCKCLEAN1614893050_1A.txt",
                        "clean_4rws_ck", "ccn_4rws_ck",     # object resno, ccn
                        "clean_4rws_ckr", "bw_4rws_ckr",  # ligand resno, bw
                        "4rws",                           # PDB ID
                        "full")                           # PDB "class"
  ...
  # (5) CX3CL1:US28
  cna.4xt1 <- LoadAtlas("01_structure_contacts/data/raw/4XT1CKCLEAN1614893099_1A.txt",
                        "clean_4xt1_ck", "ccn_4xt1_ck",     # object resno, ccn
                        "clean_4xt1_ckr", "bw_4xt1_ckr",  # ligand resno, bw
                        "4xt1",                           # PDB ID
                        "full")                           # PDB "class"
  ...
  # (6) CCL5[5P7]:CCR5
  cna.5uiw <- LoadAtlas("01_structure_contacts/data/raw/5UIWCKCLEAN1614893144_1A.txt",
                        "clean_5uiw_ck", "ccn_5uiw_ck",     # object resno, ccn
                        "clean_5uiw_ckr", "bw_5uiw_ckr",  # ligand resno, bw
                        "5uiw",                           # PDB ID
                        "full")                           # PDB "class"
  ...
  # (7) CXCL12:CXCR4
  cna.2k05 <- LoadAtlas("01_structure_contacts/data/raw/2K05CLEAN1614892909_1A.txt",
                        "clean_2k05_ck", "ccn_2k05_ck",   # object resno, ccn
                        "clean_2k05_ckr", "bw_2k05_ckr",  # ligand resno, bw
                        "2k05",                           # PDB ID
                        "soluble")                        # PDB "class"
  ...
  # (8) CCL5:CCR5
  cna.6fgp <- LoadAtlas("01_structure_contacts/data/raw/6FGPCLEAN1614893227_1A.txt",
                        "clean_6fgp_ck", "ccn_6fgp_ck",     # object resno, ccn
                        "clean_6fgp_ckr", "bw_6fgp_ckr",    # ligand resno, bw
                        "6fgp",                             # PDB ID
                        "soluble")                          # PDB "class"
  ...
  # (9) CX3CL1.35:US28
  cna.5wb2 <- LoadAtlas("01_structure_contacts/data/raw/5WB2CLEAN1614893188_1A.txt",
                        "clean_5wb2_ck", "ccn_5wb2_ck",     # object resno, ccn
                        "clean_5wb2_ckr", "bw_5wb2_ckr",    # ligand resno, bw
                        "5wb2",                             # PDB ID
                        "full")                             # PDB "class"
  ...
  # (10) CCL20:CCR6
  cna.6wwz <- LoadAtlas("01_structure_contacts/data/raw/6WWZCLEAN1614893321_1A.txt",
                        "clean_6wwz_ck", "ccn_6wwz_ck",     # object resno, ccn
                        "clean_6wwz_ckr", "bw_6wwz_ckr",    # ligand resno, bw
                        "6wwz",                             # PDB ID
                        "full")                             # PDB "class"
  ...
  # (11) CXCL8:CXCR2
  cna.6lfo <- LoadAtlas("01_structure_contacts/data/raw/6LFOCLEAN1614893266_1A.txt",
                        "clean_6lfo_ck", "ccn_6lfo_ck",     # object resno, ccn
                        "clean_6lfo_ckr", "bw_6lfo_ckr",    # ligand resno, bw
                        "6lfo",                             # PDB ID
                        "full")                             # PDB "class"
  ...
  # write df
  write_csv(cna.master, "01_structure_contacts/output/RIN_atom_1angstrom.csv")
  ...
  # write df
  # write_csv(cna.master, "01_structure_contacts/output/RIN_residue_1angstrom.csv")
  # write_csv(cna.master.sc, "01_structure_contacts/output/RIN_residue_sc_1angstrom.csv")
