# Imports sequences, generates motifs for each sequence, writes output
...
# import alignment
aln <- readAAMultipleAlignment("data/sequence/gpcr/alignments/NTERM_CYSLESS_NOGAP.fasta")                   
...
# write raw output
write.csv(mer2, "data/motif/raw/CKR_UNSTRUCTURED_2MERS_RAW_CYSLESS.csv")
rm(mer2) 
...
# write raw output
write.csv(mer3, "data/motif/raw/CKR_UNSTRUCTURED_3MERS_RAW_CYSLESS.csv")
rm(mer3)
...
# write raw output
write.csv(mer4, "data/motif/raw/CKR_UNSTRUCTURED_4MERS_RAW_CYSLESS.csv")
rm(mer4)

# (2) TIDY, ADD INFORMATION, & WRITE OUTPUT ----------------------------------
mer2 <- Raw2Motif("data/motif/raw/CKR_UNSTRUCTURED_4MERS_RAW_CYSLESS.csv",
                  "data/lookup/cc_cxc_ack.csv", "mer2", "none")

mer3 <- Raw2Motif("data/motif/raw/CKR_UNSTRUCTURED_4MERS_RAW_CYSLESS.csv",
                  "data/lookup/cc_cxc_ack.csv", "mer3", "none")

mer4 <- Raw2Motif("data/motif/raw/CKR_UNSTRUCTURED_4MERS_RAW_CYSLESS.csv",
...
# write_csv(data, "data/motif/processed/CKR_UNSTRUCTURED_ALL_MERS_CYSLESS.csv")
# WRITTEN 20231001
