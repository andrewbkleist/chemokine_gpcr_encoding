# Name:     05_snp_cancer_ckr_nt_excl_motif.R
# Updated:  20210712
...
##### 0: IDENTIFY EXCLUSIVE NTERM ##############################################
  ...
  lookup.motif <- read_csv("08_ckr_motif/data/processed/20210710_motif_conversion_3mer_ckr_nterm.csv")
  
  # import MOTIF CONSERVATION
  motif.cons <- read_csv("08_ckr_motif/output/CKR_MOTIF_FREQUENCY_NTERM.csv") %>% 
  ...
  write_csv(lookup.motif, "60_snp_cancer/data/processed/ckr_excl_motif_nt_aln_pos.csv") 
...
##### 1: RECEPTOR NTERM SNP ######################################################
  ...
  # import lookup 
  lookup.motif <- read_csv("60_snp_cancer/data/processed/ckr_excl_motif_nt_aln_pos.csv")
  ...
  chisq.test(c(160, 26875), p=c(100, 586)/(100 + 586))
