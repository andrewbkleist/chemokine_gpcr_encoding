## **fragments** and **short linear motifs (SLiMs)** in the **chemokine N-terminus**
...
- *"fragment"* - amino acid sequence found in the N-terminus of at least 1 chemokine
...
- *"paralog count"* - number of paralogs (i.e. human chemokines) in which this fragment is found
- *"total no. of paralogs"* - total number of human paralogs. For 3 chemokines no 1:1 orthologs could be identified (i.e., CX3CL1, XCL1, and XCL2 ) so these chemokines were not considered for ortholog or paralog scoring.
