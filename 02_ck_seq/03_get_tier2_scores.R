...
# NOTE 1 (20202025):
# TOPIC: RANDOMIZATION OF SEQUENCES (FROM METHODS)
# To avoid generating test sets that contained residues at a particular position 
# that was not present at the same position in the training data, random seeds 
# were identified empirically in a small number of instance; i.e. trial and
# error was used to find a random seed that caused train-test splits that would
