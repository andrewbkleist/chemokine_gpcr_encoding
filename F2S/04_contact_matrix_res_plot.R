# Description:
# Creates contact matrix using common chemokine nomenclature (CCN) and GPCRdb
# nomenclature (a common GPCR numbering system) and for each pair of contacts
# represents the number of structures which represent that contact
